...
export default function Footer() {
    return (
        <>
            <div className='mt-12'>
                <footer className="w-full text-slate-600 py-10">
                    <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row items-center justify-between gap-6'>
                        <div className='text-center md:text-left'>
                            <h3 className='text-lg font-semibold'>BookStore</h3>
                            <p className='text-sm text-gray-500'>Handpicked books to help you grow.</p>
                        </div>
